  ...
  return (
    <div className="flex justify-between px-[5rem] py-[0.5rem] md:py-[1rem] bg-white fixed top-0 w-[100vw] z-50">
      ...
      <ul className="hidden bg-[purple] max-[450px]:z-10 max-[450px]:p-[1rem] ml-[-4.9rem] md:ml-0 max-[450px]:h-[58vh] max-[450px]:w-[98vw] md:bg-transparent mt-[4.5rem] md:mt-[0rem] navbar md:flex gap-[3rem] pt-[0.5rem] max-[450px]:absolute">
        <Link to={"/"}>
          <li className="text-white md:text-[#c44ac4] max-[450px]:mb-[0.6rem] max-[450px]:pt-2 max-[450px]:pb-3">
            <a
        ...
        <li className="text-white md:text-[#c44ac4] max-[450px]:mb-[0.6rem]">
          <Link to={"/all-properties"}>
            <a
              href="#properties"
              className="no-underline hover:text-[#f065f0] md:text-[#992c99] max-[450px]:pt-2 max-[450px]:pb-3 md:hover:text-[#fa70fa]"
            >
              All Properties
            </a>
          </Link>
        ...
        <li className="max-[450px]:mb-[0.6rem]">
          <div className="dropdown relative inline-block">
            <button className="dropbtn max-[450px]:text-white max-[450px]:pt-2 max-[450px]:pb-3 md:text-[#992c99] md:hover:text-[#fa70fa] border-none text-[17px]">
              Categories
            </button>
        ...
        <li className="max-[450px]:mb-[0.8rem]">
          <div className="dropdown relative inline-block">
            <button className="dropbtn max-[450px]:text-white max-[450px]:pt-0 max-[450px]:pb-3 md:text-[#c44ac4] border-none text-[17px]">
              About Us
            </button>
            <div className="dropdown-content hidden bg-[#f1f1f1] min-w-[160px] absolute z-[1] shadow-xl">
              <a
